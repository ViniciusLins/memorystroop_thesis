		...
		\begin{center}
			\scalebox{0.6}{%
				\begin{tabular}{ l  l  l }
					...
					F2 & The system should furnish statistics of each level separately at the end of game & Consistency of Interface\\
					\hline
					\textbf{Usability} & & \\
					U1 & A new player should be able to use the system after less than 5 minutes training & Learnability\\
					U2 & The system should be perceived as easy to use by the majority of its users & Understandability \\
					\hline
